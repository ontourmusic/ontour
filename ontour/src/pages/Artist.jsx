...
function Artist() {
  ...
  const performSearch = async () => {
    ...
    const artistResponse = await fetch(
      `http://ec2-3-129-52-41.us-east-2.compute.amazonaws.com:8000/search_artist/${artistName}`,
      { mode: 'cors' }
    )
    ...
    const getReviews = await fetch(`http://ec2-3-129-52-41.us-east-2.compute.amazonaws.com:8000/reviews/${artistId}`, {
      mode: 'cors',
    })
    ...
    const tmArtist = await fetch(
      `https://app.ticketmaster.com/discovery/v2/attractions.json?apikey=NwphXHPsTvSzPp0XwvUNdp3vyzE3vEww&keyword=${artistName}`,
      { mode: 'cors' }
    )
  ...
  function Items({ currentItems }) {
    return (
      <>
        {currentItems &&
          currentItems.map(function (review, index) {
            return (
              <Review
                user={review[2]}
                date={review[4]}
      ...
      <div id="mobile-wrapper">
        ...
        <div className="artist">
          <aside>
            ...
            <div id="no-sidebar-sm" className="no-sidebar">
              <div className="d-block d-sm-none">
                <div className="row">
                  <div id="icon-sm" className="col-4">
                  ...
                  <div className="col-4">
                    <a href="#review">
                      <button id="write-sm" type="button" className="btn btn-dark fw-bold">
              ...
              <div className="container">
                <hr></hr>
                <h4 id="reviews" className="fw-bold">
                  Reviews ({totalReviews})
                </h4>
                {allReviews.length > 0 && (
                  <div id="clear">
                    <div id="reviews-margin" className="row">
                      <div className="col-12 col-sm-9 align-self-center">
                        <div className="rating fw-bold">Overall Rating: {aggregateRating.toFixed(1)} out of 5</div>
                    ...
                    <div id="page" className="list-group">
