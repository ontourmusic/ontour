...
const ArtistContent = (props) => {
  ...
  function PaginatedItems({ itemsPerPage }) {
    ...
    const handlePageClick = (event) => {
      const newOffset =
        (event.selected * itemsPerPage) % props.filteredReviews.length;
      console.log(
      ...
      <>
        <div style={review_display_styles.paginated_div}>
          ...
          <ReactPaginate
            ...
            nextLabel={
              <ArrowForwardIosIcon style={review_display_styles.page_arrow} />
            }
            breakLabel="..."
            ...
            previousLabel={
              <ArrowBackIosIcon style={review_display_styles.page_arrow} />
            }
