...
function ArtistHeader(props) {
  ...
  return (
    <div
      ...
      className="container-fluid jumbotron bg-cover text-white"
      style={{
    ...
    >
      <div
        id="text-contain"
        style={{ background: isMobile ? 'linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5))' : '' }}
      >
        <h1 id="artist-name" className="fw-bold">
          {props.name}
        </h1>
        <div className="rating">
          ...
          />
          <h1 className="fw-bold" style={{ paddingTop: '6px' }}>
            ({props.total})
          </h1>
        </div>
