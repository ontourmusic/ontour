...
export default function WriteReview(props) {
  ...
  const postData = async () => {
    ...
    await fetch(
      `http://ec2-3-129-52-41.us-east-2.compute.amazonaws.com:8000/reviews/?artist_id=${props.artistId}&event_id=1&rating=${rating}&description=${encodedDescription}&fname=${first}&lname=${last}&eventname=${event}&date=${eventDate}`,
  ...
  return (
    <div className="container" id="review">
      {/* {media && <img src={media} className="d-block w-100" alt="..."/>} */}
      {/* // <img src="https://www.adobe.com/content/dam/cc/us/en/creativecloud/photography/discover/concert-photography/thumbnail.jpeg" className="d-block w-100" alt="..."/> */}
      <hr></hr>
      <h4 id="write-review" className="fw-bold">
        Rate Your Experience
      </h4>
      <div className="rating row">
        <div id="stars" className="col-3">
          <Rating
            name="rating"
            size="large"
            required
      ...
      <form id="clear" onSubmit={handleWriteReview}>
        ...
        <div className="row bottom">
          <div className="col">
            {/* <input type="text" className="form-control shadow-none" onChange={event => setEvent(event.target.value)} value ={eventName} placeholder="Event Name" required/> */}
            {reviews.length > 0 && (
              <>
                <Form.Select
        ...
        <div className="row bottom">
          <div className="col">
            {/* <textarea className="form-control shadow-none" style={{whiteSpace: "pre-wrap"}}  rows="5" cols="100" id="description" maxLength={5000} onChange={event => setDescription(event.target.value)} value ={description} placeholder="How was your experience?" required></textarea> */}
            <textarea
              className="form-control shadow-none"
        ...
        <div>
          <button id="reviewbutton" className="btn btn-dark fw-bold" type="submit">
            Submit
          </button>
        </div>
      </form>
      {!canSubmit && (
        <div className="alert alert-danger fw-bold" role="alert" style={{ marginTop: '25px' }}>
